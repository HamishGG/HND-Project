...
if(isset($_POST['username']) && isset($_POST['userpass'])){ 
	...
	$loginsql="select userid, userpass, salt, firstname, surname, usertype from Login_Graded_Unit where username=?";
	...
	if($lgnstmt->num_rows==1) {
		...
		if($cyphertext==$hash) {
			...
			$sessionsql="update Login_Graded_Unit set sessionid=? where userid=?";
