...
$sql="select username,emailadd from Login_Graded_Unit where username=? or emailadd=?;";
$stmt=$db->prepare($sql);
...
// insert new user
	$insertquery="insert into Login_Graded_Unit (username, firstname, surname, emailadd, dob, usertype, tnc, salt, userpass) values (?,?,?,?,?,2,?,?,?);";
